...
#### 管理端主页
设备认证管理后台界面，显示总反馈52条（建议37、投诉6、举报8），含分类筛选、状态筛选、搜索框

![管理端主页](docs/screenshots/admin-homepage.jpg)

#### 管理端评论页
反馈界面显示"已有解决方案"+"讨论与沟通"区，展示用户与管理员对话记录

![管理端评论页](docs/screenshots/6617a671-4543-46a4-9adf-efd63757f079.jpg)

### 用户端界面

#### 用户端主页（💻 桌面版）
"匿证"标题，"开始匿名反馈"和"我的反馈"按钮，端到端加密提示，通知中心面板（未读1、已读8）

![用户端主页（桌面版）](docs/screenshots/user-home-desktop.jpg)

#### 我的反馈（💻 桌面版）
设备ID显示，反馈统计（全部40、处理中40、已解决0、暂不解决0），含搜索和筛选功能

![我的反馈](docs/screenshots/cc986338-f959-481c-bb1e-782ccb8c48a0.jpg)

#### 用户端主页（📱 移动版）
移动端主页，显示总反馈数53、加密率100%、数据泄露0，功能说明卡片

![用户端主页（移动版）](docs/screenshots/image---2ef9a05e-d8d4-47c8-b28e-c412d8e2b6a8.jpg)

#### 通知中心（📱 移动版）
通知中心面板，未读通知(2)、已读通知(10)，含管理员回复和状态更新
...
如果 AnonyProof 对你有帮助，欢迎通过微信或支付宝支持我：

**[💰 查看支持方式](SPONSORS.md)**

或者给个项目 Star ⭐

**💬 微信（广东 深圳）**: 备注 "AnonyProof"
